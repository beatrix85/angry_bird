...
class __TwigTemplate_5a8f931909c4e531669bf18b53cee49c14b6a50ebfe9046863e51ea8a3cdd49a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/Applications/MAMP/htdocs/Oclock/Symfony_oclock/symfo-s01e03-exo-getting-started-beatrix85/angrybird/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
